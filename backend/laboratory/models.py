...
class LabReport(models.Model):
    ...
    ordered_by_doctor = models.ForeignKey(
        "staff.StaffProfile",
        on_delete=models.PROTECT,
    ...
    technician = models.ForeignKey(
        "staff.StaffProfile",
        on_delete=models.PROTECT,
        related_name="processed_lab_reports",
        null=True,
        blank=True
    )
    ...
    finding_notes = models.TextField(
        blank=True,
        default=""
    )
    ...
    def __str__(self):
        return f"{self.report_id} - {self.test.test_name}"